  ...
  plugins: [
    ...
    new Repack.plugins.ModuleFederationPluginV2({
      ...
      shared: {
        ...
        // Stateful/context lib (ThemeProvider/useTheme): MUST be a singleton so
        // the miniapp and host share ONE React context — otherwise useTheme
        // throws "must be used within a <ThemeProvider>" when mounted.
